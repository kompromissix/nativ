...
export default function Str1({navigation}) {
        ...
        <View style={styles.top_main}>
          <View style={styles.top}>
            <View style={styles.top_top}>
              <TouchableOpacity style={styles.but2} onPress={() => navigation.navigate('Str2')}>
        ...
        <View style={styles.bottom_main}>
          <View style={styles.bottom}>
            ...
            <View style={styles.text_bottom_main}>
              <TouchableOpacity style={styles.but} onPress={() => navigation.navigate('Str3')}>
